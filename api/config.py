...
class Settings(BaseSettings):
    ...
    API_DESCRIPTION: str = """
API для автоматической генерации SEO метатегов (H1, Title, Description).

Основные возможности:
- Получение частотности запросов через Wordstat
- Анализ конкурентов через Yandex Search
- Парсинг и извлечение существующих метатегов
- Классификация типа страницы (опционально)
- Генерация новых метатегов через LLM
- Проверка и корректировка метатегов (опционально)
    """
